package com.cucumberintegration.jalo;
...
import com.cucumberintegration.constants.CucumberIntegrationConstants;


/**
 * This is the extension manager of the cucumberintegration extension.
 */
public class CucumberIntegrationManager extends GeneratedCucumberIntegrationManager {
    /**
     * Edit the local|project.properties to change logging behavior (properties 'log4j.*').
     */
    private static final Logger LOG = LoggerFactory.getLogger(CucumberIntegrationManager.class);

	/*
     * Some important tips for development: Do NEVER use the default constructor of manager's or items. => If you
	 * want to
     ...
     */
    public static CucumberIntegrationManager getInstance() {
        return (CucumberIntegrationManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
                .getExtension(CucumberIntegrationConstants.EXTENSIONNAME);
    }
     ...
     */
    public CucumberIntegrationManager() // NOPMD
    {
        LOG.debug("constructor of CucumberIntegrationManager called.");
    }
    ...
    @Override
    public void init() {
        LOG.debug("init() of CucumberIntegrationManager called, current tenant: {}", getTenant().getTenantID());
    }

    /**
     * Use this method as a callback when the manager instance is being destroyed (this happens before system
     * initialization, at redeployment or if you shutdown your VM). Note that if you have more than one tenant you
     * have a
     * manager instance for each tenant.
     */
    @Override
    public void destroy() {
        LOG.debug("destroy() of CucumberIntegrationManager called, current tenant: {}", getTenant().getTenantID());
    }
